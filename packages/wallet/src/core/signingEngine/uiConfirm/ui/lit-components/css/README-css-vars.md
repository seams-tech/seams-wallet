...
- Generator: `node packages/wallet/scripts/codegen/generate-w3a-components-css.mjs`
...
- Verify changes to `client/src/core/signingEngine/uiConfirm/ui/lit-components/css/w3a-components.css` and commit.
...
- Check `packages/wallet/scripts/codegen/generate-w3a-components-css.mjs` and `client/src/theme/base-styles.js` for the current mapping and output shape.
